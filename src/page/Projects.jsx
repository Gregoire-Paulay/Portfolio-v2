      ...
      <div className="projectsPage">
        ...
        {language === "fr" ? (
          ...
          >
            ...
            indispensable d'intéger certains concepts comme l'accessibilité, la
            sécurité ainsi qu'un contenu responsive au sein de mes créations.
            Excépté le projet TechSight, tout mes autres projets sont documentés
            dans mon <a href="https://github.com/Gregoire-Paulay">GitHub</a>.
          </p>
        ) : (
          <p
            className={
          ...
          >
            ...
            Beyond the functionalities of the application it seems essential for
            me to integrate certain concepts such as accessibility, security as
            well as responsive content within my creations. Except the TechSight
            project, all my other projects are documented in my{" "}
